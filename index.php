...
<style>
	...
	<body>
		...
		<!-- Header -->
			<header id="header">
				<div class="logo"><a href="#">Greaty Probe</a></div>
			</header>
			...
			<section id="main">
				...
				<!-- Two -->
					<section id="two" class="wrapper style2">
						<header>
							<h2>服务器实时数据</h2>
							<p>以下数据仅供参考，请以实测数据为准</p>
						</header>
						<div class="content">
						
							<!-- 服务器实时数据 -->
							<table style="color:#FFFFFF" class="table table-condensed  table-bordered ">
 								<tr>
				...
				<!-- Three -->
					<section id="three" class="wrapper">
						<div class="spotlight">
							...
							<div class="inner">
								<h3><a class="button special big">硬盘使用状况</a></h3>
						...
						<div class="spotlight alt">
							...
							<div  class="inner">
								<h3><a class="button special big">内存使用状况</a></h3>
								<tr>
								    <td colspan="5">
										物理内存：共
						...
						<div class="spotlight">
							...
							<div class="inner">
								<h3><a class="button special big">系统平均负载</a></h3>
		...
		<!-- Footer -->
			<footer id="footer">
				<div class="container">
					<ul class="icons">
						<li><a href="https://github.com/pullba/GreatyProbe" class="icon fa-github"><span class="label">Github</span></a></li>
					</ul>
				</div>
				<div class="copyright">
					&copy; Greaty. All rights reserved.<a href="http://www.rmcweb.cn/" target="_blank" title="MCweb">MCweb</a> - By <a href="http://www.pullba.xyz" title="PullBa" target="_blank">Greaty</a>
				</div>
			</footer>
